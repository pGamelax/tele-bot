...
interface PaymentButton {
  text: string;
  value: string; // String para facilitar input, converter para número depois
}
...
function NewBotPage() {
    ...
    try {
      ...
      const response = await fetchWithAuth("/api/bots", {
        ...
        body: JSON.stringify({
          ...
          startCaption: startCaption || undefined,
          resendImage: resendImage || undefined,
          resendCaption: resendCaption || undefined,
          resendFirstDelay,
          resendInterval,
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        <h1 className="text-xl sm:text-2xl font-bold text-gray-900 mb-2">Criar Novo Bot</h1>
        <p className="text-sm sm:text-base text-gray-600">Configure seu bot do Telegram para vendas</p>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="Seu API Secret do SyncPay"
                  required
                  className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
          ...
          <CardContent className="space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <Textarea
                  ...
                  placeholder="Bem-vindo ao meu bot!"
                  rows={4}
          ...
          <CardContent className="space-y-4">
              ...
              <div className="space-y-2 mt-4">
                ...
                <Textarea
                  ...
                  placeholder="Não perca nossas ofertas!"
                  rows={4}
                  className="bg-gray-50 border-gray-200 text-gray-900 placeholder:text-gray-400 focus:border-blue-500 focus:ring-blue-500 resize-none"
                />
              </div>
                    ...
                    <div key={index} className="flex gap-3 items-end">
                      ...
                      {resendPaymentButtons.length > 1 && (
                        <Button
                          ...
                          className="text-gray-500 hover:bg-red-50 hover:text-red-600 mb-0.5"
                        >
